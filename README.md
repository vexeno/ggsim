...
![](https://i.imgur.com/NHputwV.png)
4. 创建密码，点击 **Register**。
![](https://i.imgur.com/rXN5kXT.png)

5. 选择 **No,thanks**，点击 **Continue**。
![](https://i.imgur.com/hszk79p.png)
...
10. 出现的号码就是你的手机号（日常使用将号码前面的 `0` 改为英国区号 `+44`），如果未出现号码，看下一步。
...
|  **打电话**       |   1 英镑/分钟 |
| **流量**    | 0.2 英镑/MB   |
|**流量套餐（可选）** | 12英镑/1GB/月、24英镑/5GB/月、36英镑/10GB/月  |
...
🚫不建议联系 +86 号码，国内运营商通常拦截境外电话和短信，且有概率触发反诈风控，导致 +86 号码被停号。
